...
# Child classes for each reward shaping variant:

# If the strategy sequence is a *partial match* in the current trajectory
# If DECAY, Decay reward shaping at DECAY_PARAM rate after DECAY_N timesteps

# R_{action} Additional reward = % of the current action reward
...
# R_{goal} Additional reward = % of the goal reward
...
# R_{trajectory} Additional reward = % of the current trajectory reward
